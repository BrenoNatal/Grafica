...
public class GraficaTest {
    ...
    public void testarRevezamentoImpressoras() {
        ...
        assertEquals("1",1, impressora1.getQuantidadeDocumentosImpressos());
        assertEquals("2",1, impressora2.getQuantidadeDocumentosImpressos());
        assertEquals("3",1, impressora3.getQuantidadeDocumentosImpressos());
